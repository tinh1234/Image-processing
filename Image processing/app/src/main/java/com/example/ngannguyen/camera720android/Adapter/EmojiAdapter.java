...
public class EmojiAdapter extends RecyclerView.Adapter<EmojiAdapter.EmojiViewHolder> {
    ...
    EmojAdapterListener listener;

    public EmojiAdapter(Context context, List<String> emojiList, EmojAdapterListener listener){
    ...
    public interface EmojAdapterListener{
